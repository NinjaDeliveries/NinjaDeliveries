...
import { db, logActivity } from "../context/Firebase";
...
const toggleStatus = async () => {
  ...
  const adminFunctions = [
  {
    ...
    link: "/AddItems",
    image: "https://www.shutterstock.com/image-vector/shopping-cart-icon-flat-design-260nw-570153007.jpg",
  ...
  },
  {
    ...
    link: "/AddSalesItems",
    image: "https://imgs.search.brave.com/IUau1I4TDa9u1esoESIONT4uqloOvI_CeZ37SIYk4xY/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly90My5m/dGNkbi5uZXQvanBn/LzE0LzQ5LzkyLzUw/LzM2MF9GXzE0NDk5/MjUwODhfSmdib05X/ZVdWWTZXeG5ma2Zm/YU83SFQwUEkzc29j/NzkuanBn",
    permission: "manage_products",
  },
  {
    ...
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSlSjpT0YPXyFzHpBKIPoedcq1J-G-9c25Jxw&s",
  ...
  },
  {
    ...
    image: "https://th.bing.com/th/id/OIP.iqECocLdMWBmaE8bYs_lmgHaHa?rs=1&pid=ImgDetMain",
  ...
  },
  {
    ...
    link: "/promocode",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRy0mxFWath8sVF7DEyGuyEtIpErJ1cwxo9JA&s",
  ...
  },
  {
    ...
    link: "/referralcode",
    image: "https://www.idfcfirst.bank.in/content/dam/idfcfirstbank/images/blog/earn-money-by-referring-personal-loan-717x404.jpg",
    permission: "manage_coupons",
  },
  {
    title: "Transaction",
    ...
    link: "/addtransaction",
    image: "https://m.economictimes.com/thumb/msid-74960608,width-1200,height-900,resizemode-4,imgsize-49172/upi-twitter.jpg",
    permission: "manage_riders",
  },
  {
    title: "Orders List",
    ...
    link: "/orderlist",
    image: "https://img.freepik.com/free-vector/flat-payment-receipt_23-2147922105.jpg",
  ...
  },
  {
    ...
    image: "https://imgs.search.brave.com/3trWBNSGJn8mOcWHknCTQNHuvWlkVZx8P1ACGEgTefA/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly90My5m/dGNkbi5uZXQvanBn/LzE1LzE4LzE4Lzc0/LzM2MF9GXzE1MTgx/ODc0MzBfQ3c2QW1N/a0lta0JIRjVGcWlO/OHkwNnFCWUVDNmx1/SnUuanBn",
    permission: "manage_users",
  },
  {
    ...
    link: "/hotspot",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-UA1171fBWRqYWcXTe3Dutocy4I_CaIQzog&s",
    permission: "manage_orders",
  },
  {
    ...
    image: "https://firebasestorage.googleapis.com/v0/b/ninjadeliveries-91007.firebasestorage.app/o/banners%2Fvocal.png?alt=media&token=d5529679-ddf7-487b-8527-3e7d62887051",
  ...
  },
  {
    ...
    image: "https://repository-images.githubusercontent.com/44112601/e7646680-3302-11eb-91df-9962cfb40da5",
    permission: "manage_coupons",
  },
  {
...
>
  ...
  // owner / all-access
  if (user?.roleKey === "all_access_admin") return true;
