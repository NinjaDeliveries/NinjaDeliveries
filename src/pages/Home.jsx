    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="ninja-header text-center">
        ...
        <div className="rider-toggle-single-wrapper">
          ...
          <button
            className={`rider-status-toggle ${isActive ? "status-active" : "status-offline"
              }`}
          ...
          <button
            className={`edit-welcome-btn ${homeMessage?.enabled ? "has-message" : ""
              }`}
  ...
  <div className="card-grid">
    {adminFunctions
      .filter((card) => {
        ...
        // ❌ No permission on card = NO access
