...
export default function ListingNewItems() {
  ...
  const handleSubmit = async (e) => {
    ...
    const imageName = `sales/${image.name}`;
    ...
    try {
      await setDoc(doc(db, "saleProducts", name), {
        name: name,
        imageCdn: imageCdn,
      ...
      <div className="card">
        <div className="card-header">
          <div className="header-content">
            ...
            <div>
              <h2>Add New Sales Product</h2>
              <p className="header-subtitle">
                Fill in the details to list a new sales product in your
                inventory
              </p>
            </div>
          </div>
