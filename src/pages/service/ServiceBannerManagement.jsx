...
function ServiceBannerManagement({ onBack }) {
        ...
        <div className="modern-modal-backdrop">
          <div className="modern-modal">
            ...
            <div className="modern-modal-footer">
              <button className="modern-secondary-btn" onClick={() => setIsAddDialogOpen(false)}>
                Cancel
              </button>
              <button 
      ...
      {previewBanner && (
        <div className="modern-modal-backdrop">
          <div className="modern-modal large">
            ...
            <div className="modern-modal-footer">
              <button className="modern-secondary-btn" onClick={() => setPreviewBanner(null)}>
                Close
              </button>
            </div>
          </div>
      ...
      {editingBanner && (
        <div className="modern-modal-backdrop">
          <div className="modern-modal">
            ...
            <div className="modern-modal-footer">
              <button className="modern-secondary-btn" onClick={() => setEditingBanner(null)}>
                Cancel
              </button>
              <button className="modern-primary-btn" onClick={handleEditBanner}>
                Save Changes
              </button>
            </div>
          </div>
...
export default ServiceBannerManagement;
