...
const AddServiceModernUI = ({ onClose, onSave, editMode = false, initialData = null }) => {
  ...
  const handleSubmit = () => {
    ...
    // Convert quantityOffers to packages format for Firestore
    const packages = formData.quantityOffers.map(offer => ({
      duration: formData.duration,
      unit: formData.durationUnit,
      price: calculateOfferPrice(offer),
